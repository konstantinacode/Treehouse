...
var fNum = prompt("Please type a number");
...
var sNum = prompt("Please type another number");
...
//    "3 / 4 = 0.75"
//    "3 - 4 = -1"
message += fNum + " * " + sNum + " = " + (fNum * sNum) + "<br>";
message += fNum + " / " + sNum + " = " + (fNum / sNum) + "<br>";
message += fNum + " - " + sNum + " = " + (fNum - sNum) + "</p>";
